---
title: "RHEL Updates at Scale with Satellite and Foreman"
...
If you're running more than a couple of RHEL VMs, you'll quickly realize that pointing all of them at public repos for updates is slow and uncontrolled.
...
### 4. Client Registration: The Satellite/Foreman Way
...
Satellite/Foreman is a bit of work to set up, but if you're running more than a handful of RHEL VMs, it pays for itself quickly.
...
If you're just getting started, check out the [official Satellite docs](https://docs.redhat.com/en/documentation/red_hat_satellite/6.17/html/installing_satellite_server_in_a_connected_network_environment/index) (Red Hat account required). And remember: always test your patches before you go to prod.
